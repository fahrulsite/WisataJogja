package com.fahrul.wisatajogja.model
...
object dataWisata {
    ...
    private val wisataDetail = arrayOf(
        "Taman Sari Yogyakarta atau Taman Sari Keraton Yogyakarta adalah situs bekas taman atau kebun istana Keraton Ngayogyakarta Hadiningrat, yang dapat dibandingkan dengan Kebun Raya Bogor sebagai kebun Istana Bogor. Kebun ini dibangun pada zaman Sultan Hamengku Buwono I pada tahun 1758-1765/9.",
    ...
    private val wisataAddress = arrayOf(
        ...
        "jl. Ringroad Utara, Jongkang, Sariharjo, Kec. Ngaglik, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55581",
        "Jl. Raya Solo - Yogyakarta No.16, Kranggan, Bokoharjo, Kec. Prambanan, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55571",
        "Glagah, Temon, Kulonprogo, DIY",
    ...
    val listData: ArrayList<Wisata>
        get() {
            ...
            for (position in wisataName.indices) {
                ...
                wisata.detail = wisataDetail[position]
                wisata.photo = wisataImage[position]
                wisata.address = wisataAddress[position]
                wisata.time= wisataTime[position]
                list.add(wisata)
            }
            return list
        }
